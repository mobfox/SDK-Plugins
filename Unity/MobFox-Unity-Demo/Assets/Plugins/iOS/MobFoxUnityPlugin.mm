...
- (void)MobFoxNativeAdDidFailToReceiveAdWithError:(NSError *)error {
    ...
    NSLog(@"dbg: ### MobFoxUnityPlugin >> MobFoxNativeAdDidFailToReceiveAdWithError >> %@",[error description]);

    if (self.gameObject!=nil) UnitySendMessage([self.gameObject UTF8String], "nativeError", [[error description] UTF8String]);
}
