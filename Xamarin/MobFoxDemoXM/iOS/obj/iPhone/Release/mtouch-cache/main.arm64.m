...
extern void *mono_aot_module_MobFoxDemoXM_iOS_info;
...
extern void *mono_aot_module_MobFoxDemoXM_info;
extern void *mono_aot_module_Xamarin_Forms_Xaml_info;
extern void *mono_aot_module_Plugin_MobFoxAds_info;
extern void *mono_aot_module_Plugin_MobFoxAds_Abstractions_info;
extern void *mono_aot_module_AppleBinding_info;

void xamarin_register_modules_impl ()
{
	mono_aot_register_module (mono_aot_module_MobFoxDemoXM_iOS_info);
	...
	mono_aot_register_module (mono_aot_module_MobFoxDemoXM_info);
	mono_aot_register_module (mono_aot_module_Xamarin_Forms_Xaml_info);
	mono_aot_register_module (mono_aot_module_Plugin_MobFoxAds_info);
	mono_aot_register_module (mono_aot_module_Plugin_MobFoxAds_Abstractions_info);
	mono_aot_register_module (mono_aot_module_AppleBinding_info);
...
void xamarin_register_assemblies_impl ()
{
	...
	xamarin_open_and_register ("AppleBinding.dll", &exception_gchandle);
	xamarin_process_managed_exception_gchandle (exception_gchandle);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "MobFoxDemoXM.iOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 2;
