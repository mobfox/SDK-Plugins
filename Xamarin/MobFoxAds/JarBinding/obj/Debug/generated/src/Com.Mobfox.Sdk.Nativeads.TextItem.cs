...
namespace Com.Mobfox.Sdk.Nativeads {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.mobfox.sdk.nativeads']/class[@name='TextItem']"
	[global::Android.Runtime.Register ("com/mobfox/sdk/nativeads/TextItem", DoNotGenerateAcw=true)]
	public partial class TextItem : global::Java.Lang.Object {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/mobfox/sdk/nativeads/TextItem", ref java_class_handle);
			}
		}
		...
		protected TextItem (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Ljava_lang_String_Ljava_lang_String_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.mobfox.sdk.nativeads']/class[@name='TextItem']/constructor[@name='TextItem' and count(parameter)=2 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.lang.String']]"
		[Register (".ctor", "(Ljava/lang/String;Ljava/lang/String;)V", "")]
		public unsafe TextItem (string p0, string p1)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (TextItem)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Com.Mobfox.Sdk.Nativeads.TextItem __this = global::Java.Lang.Object.GetObject<global::Com.Mobfox.Sdk.Nativeads.TextItem> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual unsafe string Text {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.mobfox.sdk.nativeads']/class[@name='TextItem']/method[@name='getText' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe string Type {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.mobfox.sdk.nativeads']/class[@name='TextItem']/method[@name='getType' and count(parameter)=0]"
